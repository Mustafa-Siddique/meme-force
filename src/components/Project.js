                        ...
                        <div className="project-head">
                            ...
                            <div className="about-project">
                                ...
                                <div className="action-button">
                                    <a href="/" className="btn rounded-pill py-2 px-4 text-light" style={{backgroundColor:"#F0B90B"}}>Approve</a>
                                    <a href="/" className="btn rounded-pill py-2 px-4 ms-2 text-light" style={{backgroundColor:"#F0B90B"}}>Join Pool</a>
                                </div>
                            </div>
                        </div>
                    </div>
