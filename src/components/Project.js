                            ...
                            <div className="about-project">
                                <div className="d-flex">
                                    ...
                                    <div className='fs-6 text-light'>&nbsp;
                                        <a href="/" style={{ textDecoration: "none", color: "#fff" }}> <FaGlobe /></a>&nbsp;&nbsp;
                                        <a href="/" style={{ textDecoration: "none", color: "#fff" }}><FaTelegramPlane /></a>&nbsp;&nbsp;
                                        <a href="/" style={{ textDecoration: "none", color: "#fff" }}><FaTwitter /></a>
                                    </div>
                                </div>
                                <div className="sale-stat">&bull; Open</div>
                                <div className="chain">BNB</div>
                                <p className='fs-6' style={{ color: "#6c757d" }}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, optio doloribus reiciendis velit cupiditate sapiente eius animi vel ullam quo? Accusamus rem, magnam aut non corrupti nobis porro ducimus accusantium?</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-5">
                        <div className="token-desc">
                            <div className="row">
                                <div className="col swap">
                                    <div className='position-relative' style={{maxWidth:"255px"}}>
                                        <p className='m-0'>Your balance: <span style={{fontWeight:"500"}}>0.0000 BNB</span></p>
                                        <button style={{backgroundColor:"#660033", border:"none", borderRadius:"5px", color:"#fff", position:"absolute", right:"5px", marginTop:"-5px"}}>Max</button><br />
                                        <input type="text" id='swapFrom'/>
                                    </div>
                                    <div className='position-relative mt-4' style={{maxWidth:"255px"}}>
                                        <input type="text" id='swapTo'/>
                                    </div>
                                    <button className="btn mt-4" style={{backgroundColor:"#660033", border:"none", borderRadius:"5px", color:"#fff", width:"100%"}}>Buy</button>
                                    <button className="btn mt-1 desabled text-muted" style={{backgroundColor:"#660033", border:"none", borderRadius:"5px", width:"100%"}}>Claim</button>
                                </div>
                                <div className="col">
                                    <p>Remaning allocation: <span>0.0000</span></p>
                                    <p className='m-0'>Reserved Token: <br /><span style={{fontWeight:"500"}}>0.0000 MEMEFORCE</span></p>
                                    <br />
                                    <p className='m-0'>Rate: <br /><span style={{fontWeight:"500"}}>1 BNB ≈ 1,111,111 MEMEFORCE</span></p>
                                    <br />
                                    <p>Swap Progress:</p>
