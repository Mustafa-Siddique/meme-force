...
export default function ProjectsOpen() {
  ...
  const fetchData = async () => {
    axios
      .get(
        'https://gz1p1grm.api.sanity.io/v2021-06-07/data/query/production?query=*[_type=="projectCards"]'
      )
  ...
  const renderOwner = (project, index) => {
        ...
        <div className="col-md-3 rounded px-3 py-3 mx-2 my-3" key={index}>
          ...
          <div className="card-body">
            <p className="fs-6">
              ...
              optio doloribus reiciendis velit cupiditate sapiente eius animi
              vel ullam quo? Accusamus rem, magnam aut non corrupti nobis porro
              ducimus accusantium?
            </p>
            <div className="rate">
              <p>Swap rate</p>
    ...
    return (
      <div id="openProject-cont">
        ...
        <div className="row">{project.map(renderOwner)}</div>
      </div>
    );
  };
}
